# Brewfile — managed by chezmoi (see run_onchange_before_20-brew-bundle.sh.tmpl).
# Regenerate the baseline with:  brew bundle dump --file=- --force
# then re-add the hand-kept CLI tools below. Apply with:  brew bundle --file=Brewfile
